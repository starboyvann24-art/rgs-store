...
router.post('/', auth_middleware_1.verifyToken, auth_middleware_1.isAdmin, upload_middleware_1.uploadQris.single('qris_image'), payment_controller_1.createPaymentMethod);
// PUT /api/payment-methods/:id — Update method (admin)
router.put('/:id', auth_middleware_1.verifyToken, auth_middleware_1.isAdmin, upload_middleware_1.uploadQris.single('qris_image'), payment_controller_1.updatePaymentMethod);
