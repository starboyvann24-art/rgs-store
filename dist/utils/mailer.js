...
exports.sendOrderCreatedEmail = sendOrderCreatedEmail;
exports.sendOrderPaidEmail = sendOrderPaidEmail;
...
async function sendOrderCreatedEmail(to, name, orderData) {
...
async function sendOrderPaidEmail(to, name, orderData) {
    const formattedPrice = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(orderData.total_price);
